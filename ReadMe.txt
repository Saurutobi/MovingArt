...
A power extender cable with 3 internal wires.
A household 3-pronged power socket.
A Relay board what supports AC120V 10A.
A PIR motion sensor.
A Project Box big enough to house a Raspberry pi and the other internals.
...
1.Wall power will supply the power cable into the box.
...
11.Load up the RaspberryPi with the included code.
12.Hide everything nicely in the project box.
13.Hide the project box behind the TV/Monitor.
14.Use dualsided tape to secure the PIR motion sensor to the front of the TV/Monitor.
15.Done, turn it on and watch it go!
